package one_producer_one_consumer.produce_consumer_sharedmemory_peterson;

import sleep.SleepUtilities;

import java.util.Date;

public class Provider_consumer_sharedmemory_peterson{
    public static void main(String[] args){
        ...
        Buffer server = new BoundedBuffer(permit,want);
...
class BoundedBuffer implements Buffer
{
    ...
    public BoundedBuffer(Integer p,Boolean[] w)
    {   permit=p;
        want=w;
        count = 0;
        in = 0;
